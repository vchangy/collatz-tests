...
def collatz_eval (i, j) :
    ...
    if (j - i >= 1000):
        ...
        last_thousand = int(math.floor((j - 1) / 1000.0)) * 1000
        for index in range(int(first_thousand / 1000), int(last_thousand / 1000)):
...
def get_cycle_length (i) :
    ...
    while (i != 1):
        if (i % 2 == 1):
            ...
            i = i / 2
            count = count + 1
    # Store computed cycle length in cache
    cycle_lengths[original] = count
    return count
